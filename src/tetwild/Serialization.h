...
template <>
inline void serialize(const std::array<int, 3> &arr,
...
template <>
inline void deserialize(std::array<int, 3> &arr,
...
template <>
inline void serialize(const std::array<int, 4> &arr,
                      std::vector<char> &buffer) {
  for (int i = 0; i < 4; i++)
    ::igl::serialize(arr[i], std::to_string(i), buffer);
}
...
template <>
inline void deserialize(std::array<int, 4> &arr,
                        const std::vector<char> &buffer) {
  for (int i = 0; i < 4; i++)
    ::igl::deserialize(arr[i], std::to_string(i), buffer);
}
...
inline void serialize(const tetwild::TetVertex &v, std::vector<char> &buffer) {
  ...
  //            ::igl::serialize(v.on_fixed_vertex,
  //            std::string("on_fixed_vertex"), buffer); std::vector<int> tmp;
...
inline void deserialize(tetwild::TetVertex &v,
  ...
  //            ::igl::deserialize(v.on_fixed_vertex,
  //            std::string("on_fixed_vertex"), buffer); std::vector<int> tmp;
...
//        {
//            ::igl::serialize(q.min_d_angle, std::string("min_d_angle"),
//            buffer);
//            ::igl::serialize(q.max_d_angle, std::string("max_d_angle"),
//            buffer);
//            ::igl::serialize(q.asp_ratio_2, std::string("asp_ratio_2"),
//            buffer);
//            ::igl::serialize(q.slim_energy, std::string("slim_energy"),
//            buffer);
...
//
//        template<>
//        inline void deserialize(TetQuality &q, const std::vector<char>
//        &buffer) {
//            ::igl::deserialize(q.min_d_angle, std::string("min_d_angle"),
//            buffer);
//            ::igl::deserialize(q.max_d_angle, std::string("max_d_angle"),
//            buffer);
//            ::igl::deserialize(q.asp_ratio_2, std::string("asp_ratio_2"),
//            buffer);
//            ::igl::deserialize(q.slim_energy, std::string("slim_energy"),
//            buffer);
